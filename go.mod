...
require (
	...
	github.com/refractionPOINT/go-limacharlie/limacharlie v0.0.0-20240816154204-4467097407bc
	github.com/refractionPOINT/go-uspclient v1.4.2-0.20241021004427-a7ced574c352
