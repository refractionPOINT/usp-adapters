...
require (
	...
	github.com/refractionPOINT/go-uspclient v0.0.0-20220622214516-dc5d2e208011
...
require (
	...
	github.com/refractionPOINT/go-limacharlie/limacharlie v0.0.0-20220622195708-192d7a224c92 // indirect
